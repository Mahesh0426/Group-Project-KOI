...
const GallaryPage = () => {
  ...
  const galleryItems = [
    ...
    {
      category: "robotics",
      img: "assets/robots and coding.png",
      title: "Robotics Workshop",
      desc: "Building and programming robots",
    },
    {
      category: "robotics",
      img: "assets/Robotics/testing-roborts.png",
      title: "Robot Testing",
      desc: "Testing robots on obstacle course",
    },
    {
      category: "robotics",
      img: "assets/Robotics/collaborating-instructor-guidance.png",
    ...
    // Engineering
    {
      ...
      img: "assets/Engineering/tall-tower.png",
      title: "Tower Challenge",
      desc: "Building the tallest stable tower",
    },
    {
      category: "engineering",
      img: "assets/Engineering/testing-bridge-structures.png",
      title: "Bridge Building",
      desc: "Testing bridge strength and design",
    },
    {
      category: "engineering",
      img: "assets/Engineering/3D-design.png",
      title: "3D Design",
    ...
    {
      category: "math",
      img: "assets/Math/puzzle-solving.png",
      title: "Math Puzzles",
      desc: "Solving logic and geometry puzzles",
    },
    {
      category: "math",
      img: "assets/Math/color-manipulation-calculator.png",
      title: "Hands-on Math",
      desc: "Learning with manipulatives",
    },
    {
      category: "math",
      img: "assets/Math/presenting-solution-whiteboard.png",
    ...
    // Mixed
    {
      ...
      img: "assets/mixed-Activities/showcase-certificate.png",
      title: "Achievement Celebration",
      desc: "Proud graduates with certificates",
    },
    {
      category: "chemistry engineering",
      img: "assets/mixed-Activities/showcase-parents.png",
      title: "Science Fair",
      desc: "Showcasing student projects",
    },
    {
      category: "robotics chemistry math",
      img: "assets/mixed-Activities/group-photo-teacher.png",
      title: "STEM Family",
